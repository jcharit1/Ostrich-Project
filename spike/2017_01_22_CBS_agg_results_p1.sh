...
do
   /apps/wrappers/sge_run --grid_quiet --grid_submit=batch --grid_mem=500M "find $FULL_PATH$level_1/ -name '*$BASENAME*' -exec cat {} + > /user/user1/jc4144/Nachum/Ostrich/AggOutput/temp_$level_1.txt"
done
